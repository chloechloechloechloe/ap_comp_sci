...
class starter {
	public static void main(String args[]) throws FileNotFoundException {
		...
		int checkNum; // Uses the fillArray method that has been built below. This fills the array 'arr' with each word individually in the text file.
	System.out.println("-------------------------------------------");
		...
		*/
		while(true){
			...
			if(choice.equals("1")){
				...
				System.out.println("How many words should be printed out?");
				checkNum = sc.nextInt();
				printsNumber(arr, checkNum);
			} 
			else if(choice.equals("5")){
				System.out.println("Please input new text file name");
				change();
				...
				int howManyChecks = checksArray(arr, word);
				System.out.println("There are " + howManyChecks   + " in this array");
			}
	...
	*/
	...
	public static void printsArray(String[] testArr){
	...
	*/
	public static void printsArrayBack(String[] testArr){
		for(int i=testArr.length -1; testArr.length >= 0; i--){
			System.out.println(testArr[i]);
		}
